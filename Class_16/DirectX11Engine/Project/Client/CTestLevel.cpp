...
void CTestLevel::CreateTestLevel()
{
	...
	pLight->Light3D()->SetRange(1000.f);
	...
	//pSkyBox->SkyBox()->GetMaterial()->SetTexParam(TEX_0, CAssetMgr::GetInst()->FindAsset<CTexture>(L"texture\\skybox\\Sky02.jpg"));
	...
	Player->Transform()->SetRelativeScale(Vec3(1000.f, 1000.f, 1.f));
	...
	Player->MeshRender()->SetMaterial(CAssetMgr::GetInst()->FindAsset<CMaterial>(L"Std3DDeferredMtrl"));
