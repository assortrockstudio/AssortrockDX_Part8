...
{    
    ...
    // 빛의 크기를 계산
    _Light.vDiffuse.rgb     += LightInfo.Light.vDiffuse.rgb * LightPow;
    _Light.vAmbient.rgb     += LightInfo.Light.vAmbient.rgb;
    _Light.vMaxSpecular.rgb += LightInfo.Light.vDiffuse.rgb * LightInfo.Light.vMaxSpecular.rgb * ReflectPow;
}
